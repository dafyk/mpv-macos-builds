class Libplacebo < Formula
  ...
  depends_on "dafyk/mpv/vulkan-headers" => :build
  depends_on "dafyk/mpv/glslang"
  depends_on "dafyk/mpv/shaderc"
  depends_on "dafyk/mpv/little-cms2"
  depends_on "dafyk/mpv/sdl2"
  depends_on "dafyk/mpv/vulkan-loader"
  ...
  def install
    ...
    system "meson", "setup", "build",
                    "-Dvulkan-registry=#{Formula["dafyk/mpv/vulkan-headers"].share}/vulkan/registry/vk.xml",
