class PythonAT311 < Formula
  ...
  depends_on "dafyk/mpv/mpdecimal"
  ...
  def install
    ...
    args = %W[
      ...
      --with-openssl=#{Formula["dafyk/mpv/openssl@3"].opt_prefix}
    ...
    inreplace "./Lib/ctypes/macholib/dyld.py" do |f|
      f.gsub! "DEFAULT_LIBRARY_FALLBACK = [",
              "DEFAULT_LIBRARY_FALLBACK = [ '#{HOMEBREW_PREFIX}/lib', '#{Formula["dafyk/mpv/openssl@3"].opt_lib}',"
